...
单题首屏只显示问题与 45 / 60 / 90 秒计时器。完成首答后，才依次展开口述版、知识解析、记忆钩子、单条追问和来源证据。自评支持键盘 `1–4`。
...
- 支持导出/导入带 `schemaVersion` 的完整 JSON 备份；
- 清空训练历史需要显式确认。
...
`public/data/default-dataset.json` 由《保研专业课面试｜口述版题库 v3》结构化转换。页面保留原题库的问题、答案和证据口径；**高概率预测不等于真题，同校面经不等于当年官方考题**。请根据目标院校最新官方通知调整备考范围。
